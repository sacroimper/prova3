...
public class Adaptador extends BaseExpandableListAdapter {
	...
	case 0:
		...
		textvw.setCompoundDrawablesWithIntrinsicBounds(
			R.drawable.lechonalhorno, 0, 0, 0);
		break;
	    case 1:
		textvw.setCompoundDrawablesWithIntrinsicBounds(
			R.drawable.lechonalaparrilla, 0, 0, 0);
		break;
	    }
	    break;
	case 1:
	    ...
	    break;
	case 2:
	    textvw.setCompoundDrawablesWithIntrinsicBounds(R.drawable.sandwich,
		    0, 0, 0);
	    break;
	}
	convertView.setOnClickListener(new OnClickListener() {
		...
		Toast.makeText(
			activity,
			children + " - Item: " + groupPosition + " - Subitem:"
